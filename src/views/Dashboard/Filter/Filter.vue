...
<template>
   <div class="flex gap-[30px] relative">
      <Button class="p-[8px] max-md:p-[5px]" @click="openModal()">New Task</Button>
      <button @click="onOpenFilter(!openFilter)" class="bottom-[0px]">
         <img :src="Filter" alt="filter icon" />
      </button>
      <div
         v-if="openFilter"
         class="flex z-20 shadow-lg shadow-blue-500/25 flex-col absolute gap-[13px] top-[50px] right-[5px] items-start p-[20px] bg-white"
      >
         <button
